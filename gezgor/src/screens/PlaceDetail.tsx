...
const PlaceDetail = ({route,navigation}:any) => {
  ...
  return (
    <View style={{flex:1}}>
      ...
      <View style={{flex:2,marginTop:140}}>
        ...
        <View style={{width:48,height:48,borderRadius:8,backgroundColor:'gray',alignItems:'center',justifyContent:'center'}}>
        ...
        <View style={{}}><Text style={{fontSize:12,fontWeight:'400',color:'#747688'}}>Organizer</Text></View>
        </View>
        </View>
        </View>
